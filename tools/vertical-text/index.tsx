...
import { toVertical } from './logic';

export default function VerticalTextTool({ locale, toolMeta }: { locale: string; toolMeta: ToolMeta }) {
  const t = useTranslations('tools.vertical-text');
  ...
  return (
    <ToolLayout toolMeta={toolMeta} locale={locale as any} instructions={t('instructions')}>
      <div className="flex flex-col gap-4">
        ...
        <Button onClick={() => setOutput(toVertical(input))}>{t('convert_button')}</Button>
