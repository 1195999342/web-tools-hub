...
export default function HtmlToMarkdownTool({ locale, toolMeta }: { locale: string; toolMeta: ToolMeta }) {
  ...
  return (
    <ToolLayout toolMeta={toolMeta} locale={locale as any} instructions={t('instructions')}>
      <div className="flex flex-col gap-4">
        ...
        <Button onClick={() => setOutput(htmlToMarkdown(input))}>{t('convert_button')}</Button>
        {output && (
