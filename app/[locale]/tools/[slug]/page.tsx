...
function getToolComponent(slug: string): React.ComponentType<{ locale: string; toolMeta: ToolMeta }> | null {
  ...
  const toolImportMap: Record<string, () => Promise<{ default: React.ComponentType<{ locale: string; toolMeta: ToolMeta }> }>> = {
    ...
    'useragent-gen': () => import('@/tools/useragent-gen/index'),
    'ip-tools': () => import('@/tools/ip-tools/index'),
    'mac-gen': () => import('@/tools/mac-gen/index'),
    'robots-gen': () => import('@/tools/robots-gen/index'),
    'regex-codegen': () => import('@/tools/regex-codegen/index'),
    'useragent-list': () => import('@/tools/useragent-list/index'),
    'robots-checker': () => import('@/tools/robots-checker/index'),
    'css-animation': () => import('@/tools/css-animation/index'),
    'css-neon-glitch': () => import('@/tools/css-neon-glitch/index'),
    'web-safe-colors': () => import('@/tools/web-safe-colors/index'),
    'color-picker-tool': () => import('@/tools/color-picker-tool/index'),
    'image-color-picker': () => import('@/tools/image-color-picker/index'),
    'svg-editor': () => import('@/tools/svg-editor/index'),
    'font-viewer': () => import('@/tools/font-viewer/index'),
    'css-3d-card': () => import('@/tools/css-3d-card/index'),
    'css-liquid': () => import('@/tools/css-liquid/index'),
    'css-sprites': () => import('@/tools/css-sprites/index'),
    'popup-gen': () => import('@/tools/popup-gen/index'),
    'ui-gradient-css': () => import('@/tools/ui-gradient-css/index'),
    'grid-cutter': () => import('@/tools/grid-cutter/index'),
    'image-watermark': () => import('@/tools/image-watermark/index'),
    'image-rotate': () => import('@/tools/image-rotate/index'),
    'gif-frames': () => import('@/tools/gif-frames/index'),
    'placeholder-image': () => import('@/tools/placeholder-image/index'),
    'ico-gen': () => import('@/tools/ico-gen/index'),
    'exif-viewer': () => import('@/tools/exif-viewer/index'),
    'drawing-board': () => import('@/tools/drawing-board/index'),
    'grayscale-tool': () => import('@/tools/grayscale-tool/index'),
    'image-round': () => import('@/tools/image-round/index'),
    'signature-extract': () => import('@/tools/signature-extract/index'),
    'tiff-split': () => import('@/tools/tiff-split/index'),
    'id-photo-bg': () => import('@/tools/id-photo-bg/index'),
    'ios-android-logo': () => import('@/tools/ios-android-logo/index'),
    'radix-calc': () => import('@/tools/radix-calc/index'),
    'gcd-lcm': () => import('@/tools/gcd-lcm/index'),
    'prime-gen': () => import('@/tools/prime-gen/index'),
    'fibonacci': () => import('@/tools/fibonacci/index'),
    'statistics': () => import('@/tools/statistics/index'),
    'pi-lookup': () => import('@/tools/pi-lookup/index'),
    'regression': () => import('@/tools/regression/index'),
    'vibration-calc': () => import('@/tools/vibration-calc/index'),
    'monte-carlo-pi': () => import('@/tools/monte-carlo-pi/index'),
    'euler-e': () => import('@/tools/euler-e/index'),
    'bandwidth-calc': () => import('@/tools/bandwidth-calc/index'),
    'binary-calc': () => import('@/tools/binary-calc/index'),
    'decimal-random': () => import('@/tools/decimal-random/index'),
    'crayon-colors': () => import('@/tools/crayon-colors/index'),
    'inverse-color': () => import('@/tools/inverse-color/index'),
    'xpath-tester': () => import('@/tools/xpath-tester/index'),
    'stopwatch': () => import('@/tools/stopwatch/index'),
    'csv-to-html': () => import('@/tools/csv-to-html/index'),
    'string-concat': () => import('@/tools/string-concat/index'),
    'lottie-preview': () => import('@/tools/lottie-preview/index'),
    'fontawesome-search': () => import('@/tools/fontawesome-search/index'),
    'mindmap': () => import('@/tools/mindmap/index'),
    'text-to-image': () => import('@/tools/text-to-image/index'),
    'data-viz-3d': () => import('@/tools/data-viz-3d/index'),
    'db-designer': () => import('@/tools/db-designer/index'),
    'network-topology': () => import('@/tools/network-topology/index'),
    'grid-paper': () => import('@/tools/grid-paper/index'),
    'maze-gen': () => import('@/tools/maze-gen/index'),
    'meeting-timer': () => import('@/tools/meeting-timer/index'),
    'random-picker': () => import('@/tools/random-picker/index'),
    'reaction-test': () => import('@/tools/reaction-test/index'),
    'color-blind-test': () => import('@/tools/color-blind-test/index'),
    'file-type-detect': () => import('@/tools/file-type-detect/index'),
    'ppi-calc': () => import('@/tools/ppi-calc/index'),
    'device-sizes': () => import('@/tools/device-sizes/index'),
    'html5-test': () => import('@/tools/html5-test/index'),
    'id-photo-sizes': () => import('@/tools/id-photo-sizes/index'),
    'crx-parser': () => import('@/tools/crx-parser/index'),
    'emoji-picker': () => import('@/tools/emoji-picker/index'),
    'special-symbols': () => import('@/tools/special-symbols/index'),
    'pinyin-sort': () => import('@/tools/pinyin-sort/index'),
    'zip-viewer': () => import('@/tools/zip-viewer/index'),
    'sql-to-java': () => import('@/tools/sql-to-java/index'),
    'mysql-to-java': () => import('@/tools/mysql-to-java/index'),
    'sql-to-csharp': () => import('@/tools/sql-to-csharp/index'),
    'sql-field-view': () => import('@/tools/sql-field-view/index'),
    'html-css-js-filter': () => import('@/tools/html-css-js-filter/index'),
    'json-postman': () => import('@/tools/json-postman/index'),
    'sql-to-form': () => import('@/tools/sql-to-form/index'),
    'sql-to-json': () => import('@/tools/sql-to-json/index'),
    'url-postman': () => import('@/tools/url-postman/index'),
    'sql-to-yii': () => import('@/tools/sql-to-yii/index'),
    'xml-editor': () => import('@/tools/xml-editor/index'),
    'yaml-editor': () => import('@/tools/yaml-editor/index'),
    'toml-editor': () => import('@/tools/toml-editor/index'),
    'runjs-editor': () => import('@/tools/runjs-editor/index'),
    'md2-md4-hash': () => import('@/tools/md2-md4-hash/index'),
    'shake-keccak': () => import('@/tools/shake-keccak/index'),
    'db-password-gen': () => import('@/tools/db-password-gen/index'),
    'zodiac': () => import('@/tools/zodiac/index'),
    'id-card-check': () => import('@/tools/id-card-check/index'),
    'blood-type': () => import('@/tools/blood-type/index'),
    'bmi-bmr': () => import('@/tools/bmi-bmr/index'),
    'fuel-calc': () => import('@/tools/fuel-calc/index'),
    'ev-charge-calc': () => import('@/tools/ev-charge-calc/index'),
    'disk-partition': () => import('@/tools/disk-partition/index'),
    'shichen': () => import('@/tools/shichen/index'),
    'check-date': () => import('@/tools/check-date/index'),
    'shortcut-ref': () => import('@/tools/shortcut-ref/index'),
    'cdn-lookup': () => import('@/tools/cdn-lookup/index'),
    'curl-all-langs': () => import('@/tools/curl-all-langs/index'),
  };
